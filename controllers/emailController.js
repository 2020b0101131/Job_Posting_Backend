...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        ...
        // user: "k1.saranshchauhan@gmail.com",
        // pass: "tvwswgiypugyaxje",
    },
});
    ...
    try {
        ...
        candidates.forEach((email) => {
            const mailOptions = {
                ...
                text: `Hello, We have a new job opening for ${job.title}. Experience Level: ${job.experienceLevel}. Please visit our site for more information.`,
            };
